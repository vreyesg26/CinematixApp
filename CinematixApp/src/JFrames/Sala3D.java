 ...
 * @author Los Pibes
 */
public class Sala3D extends javax.swing.JFrame {
    ...
    public void buscarAsientosReservados() {
        Conexion cc = new Conexion();
        Connection cn = cc.GetConexion();
        String sql = "SELECT Numero, IDEstado FROM asiento WHERE IDSalas = 2";
    ...
    private void initComponents() {
        ...
        lbFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/PantallaSala3D.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sala3D.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
