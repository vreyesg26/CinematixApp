 ...
 * @author Los Pibes
 */
public class SalaMax2D extends javax.swing.JFrame {
    ...
    public JToggleButton[][] JTBotones1Fila = new JToggleButton[fila1][columnas1];
    ...
    public void botones() {
        ...
        for (int i = 0; i < fila1; i++) {
            for (int j = 0; j < columnas1; j++) {
                JTBotones1Fila[i][j] = new JToggleButton();
        ...
        for (int i = 0; i < filas; i++) {
            for (int j = 0; j < columnas; j++) {
                ...
                if (contador2 >= 9 && contador2 <= 18) {
                    JTBotones[i][j].setText("B" + contador2);
                } else if (contador2 >= 19 && contador2 <= 28) {
                    JTBotones[i][j].setText("C" + contador2);
                } else if (contador2 >= 29 && contador2 <= 38) {
                    JTBotones[i][j].setText("D" + contador2);
                } else if (contador2 >= 39 && contador2 <= 48) {
                    JTBotones[i][j].setText("E" + contador2);
                } else if (contador2 >= 49 && contador2 <= 58) {
                    JTBotones[i][j].setText("F" + contador2);
                } else if (contador2 >= 59 && contador2 <= 68) {
                        ...
                        if (JTBotones1Fila[i][j].isSelected()) {
                            ...
                            if (totalBoletos == cantidadBoletos.size()) {
                                if (totalBoletos != 1) {
                                    ...
                                    JTBotones1Fila[i][j].setSelected(false);
                                } else {
                                    ImageIcon jPanelIcono = new ImageIcon("src/iconos/iconoCorrecto.png");
    ...
    public void buscarAsientosReservados() {
        Conexion cc = new Conexion();
        Connection cn = cc.GetConexion();
        String sql = "SELECT Numero, IDEstado FROM asiento WHERE IDSalas = 3";
    ...
    private void initComponents() {
        ...
        lbSeleccionCompleta = new javax.swing.JLabel();
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 131, -1, 560));
        getContentPane().add(lbSeleccionCompleta, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 420, 80, 80));

        lbFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/PantallaSalaMax2D.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalaMax2D.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel lbSeleccionCompleta;
